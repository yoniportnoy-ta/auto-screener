...
def _single_pass(
    *,
    ...
    tail = (
        ...
        "ratings land at 3-4, you are being too generous.\n\n"

        "- 5 (Superstar — ~5%): RARE. Tier-1 product company veteran with strong "
        "progression AND tier-1 university AND location match AND concrete achievements "
        ...
        "no major red flags. Most CVs do NOT clear this bar.\n"
        ...
        "- 1 (No fit — ~15%): Hard blockers — wrong country with no relocation, completely "
        "wrong skill set, entire career at service/staffing shops, or obvious "
        ...
        "specific tier-1 university, or specific recent achievements that match the role. "
        "If you cannot list three, drop the rating by one. If you cannot list any, drop "
        "to 2.\n"
        ...
        "  (c) Sanity-check: if you would describe this candidate as 'good but not "
        "exceptional', that's a 3, not a 4. 4 means 'fast-track this person today'.\n"
    )
